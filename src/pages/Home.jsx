...
const Home = () => {
  ...
  const tutors = [
    ...
    { name: "Samuel", subject: "Tennis", description: "Joueur de tennis professionnel offrant des cours pour tous niveaux.", rating: 4.8, price: "60€/h", image: "https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?auto=format&fit=crop&w=800&q=80" },
    { name: "Jean-Luc", subject: "Piano", description: "Professeur de piano expérimenté, cours adaptés à tous les âges.", rating: 4.9, price: "55€/h", image: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&w=800&q=80" },
    { name: "Aline", subject: "Biologie", description: "Docteure en biologie, spécialisée en soutien universitaire.", rating: 4.9, price: "58€/h", image: "https://images.unsplash.com/photo-1607746882042-944635dfe10e?auto=format&fit=crop&w=800&q=80" },
    { name: "Lucas", subject: "Anglais", description: "Prof d'anglais natif avec 10 ans d'expérience à l'étranger.", rating: 4.8, price: "47€/h", image: "https://images.unsplash.com/photo-1603415526960-f8f6d2c4b451?auto=format&fit=crop&w=800&q=80" },
    { name: "Emma", subject: "Design graphique", description: "Graphiste professionnelle, donne cours sur Photoshop et Illustrator.", rating: 4.7, price: "50€/h", image: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=800&q=80" },
    { name: "Thomas", subject: "Photographie", description: "Photographe indépendant partage ses techniques de pro.", rating: 4.8, price: "52€/h", image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=800&q=80" },
    { name: "Laura", subject: "Histoire", description: "Passionnée d'histoire, aide les élèves à préparer leurs examens.", rating: 4.6, price: "48€/h", image: "https://images.unsplash.com/photo-1552058544-f2b08422138a?auto=format&fit=crop&w=800&q=80" },
    { name: "Nicolas", subject: "Espagnol", description: "Professeur bilingue espagnol/français, cours dynamiques.", rating: 4.9, price: "53€/h", image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=800&q=80" }
  ];
