...
//         const tutorName = review.tutor?.name || ""
//         const studentName = review.user?.name || ""
...
//                                                 <span className="text-xs font-bold text-white">{getInitials(review.tutor?.name || "T")}</span>
//                                             </div>
//                                             <div className="w-10 h-10 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-lg flex items-center justify-center">
//                                                 <span className="text-xs font-bold text-white">{getInitials(review.user?.name || "S")}</span>
//                                             </div>
//                                         </div>
//                                         <div className="flex-1">
//                                             <div className="font-semibold text-gray-900 text-sm">
//                                                 <span className="text-blue-600">{review.tutor?.name || "Unknown Tutor"}</span> reviewed by <span className="text-emerald-600">{review.user?.name || "Unknown Student"}</span>
//                                             </div>
...
export const ReviewList = () => {
    ...
    return (
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            {/* Enhanced Header - Matching UsersList gradient exactly */}
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-8">
                <div className="flex items-center gap-3 mb-4">
                    <div className="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center">
                        <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {/* Stats Cards - Matching UsersList style exactly */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                    <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                        <div className="flex items-center justify-between">
                            <div>
            ...
            {/* Search Section - Matching UsersList style exactly */}
            <div className="p-6 bg-gray-50 border-b border-gray-200">
                <div className="flex flex-col md:flex-row gap-4">
                    <div className="flex-1 relative">
                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
