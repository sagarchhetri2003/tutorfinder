...
//   return (
//     <header
//       className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${scrolled ? "bg-white shadow border-b border-gray-100" : "bg-transparent"
//         }`}
//     >
            ...
            {!isBlurredPage && (
              user ? (
                <div className="flex items-center space-x-3">
                  ...
                  <span className="font-medium text-gray-700">Welcome back!</span>
                </div>
              ) : (
                <Link 
                  to="/login" 
